...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['hapus']) && $_POST['hapus'] == '1') {
        ...
        $sql = "DELETE FROM dm_mlbb WHERE jumlah_dm = '$label'";
    ...
    if (isset($_POST['aksi']) && $_POST['aksi'] === 'tambah') {
        ...
        $sql = "INSERT INTO dm_mlbb (jumlah_dm, harga) VALUES ('$label_baru', '$harga')";
        $result = mysqli_query($conn, $sql);
    ...
    $sql = "UPDATE dm_mlbb SET jumlah_dm = '$label_baru', harga = '$harga' WHERE jumlah_dm = '$label_lama'";
    $result = mysqli_query($conn, $sql);
